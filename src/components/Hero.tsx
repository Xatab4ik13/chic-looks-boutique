...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Decorative elements */}
      <motion.div
        className="absolute top-20 right-20 w-64 h-64 bg-accent/30 morph-blob blur-3xl"
        animate={{
          x: [0, 30, 0],
          y: [0, -20, 0],
        }}
      ...
      />
      <motion.div
        className="absolute bottom-40 left-20 w-48 h-48 bg-primary/40 morph-blob blur-2xl"
        animate={{
          x: [0, -20, 0],
          y: [0, 30, 0],
        }}
      ...
      {/* Content */}
      <motion.div
        className="relative h-full container mx-auto flex items-center"
        style={{ opacity }}
      >
        <div className="max-w-2xl">
          ...
          >
            ...
            >
              ...
              <motion.span
                className="w-12 h-12 border border-foreground flex items-center justify-center group-hover:bg-foreground group-hover:text-background transition-all duration-300"
        ...
        {slides.map((_, index) => (
          ...
          >
            <motion.div
              ...
              transition={{ duration: currentSlide === index ? 6 : 0.3 }}
      ...
      <div className="absolute left-6 top-1/2 -translate-y-1/2 hidden lg:block">
        <motion.span
          ...
          className="text-xs tracking-[0.5em] uppercase text-muted-foreground/50 writing-mode-vertical"
